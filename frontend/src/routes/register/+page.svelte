...
<div class="flex min-h-[calc(100vh-8rem)] items-center justify-center px-4 py-12">
	<div class="w-full max-w-sm">
		<div class="mb-7">
			...
			<p class="mt-1 text-sm" style="color: var(--text-muted);">Start organizing your tasks</p>
		</div>
		...
		<form onsubmit={handleSubmit} class="space-y-4">
			<div>
				<label for="username" class="mb-1.5 block text-sm font-medium" style="color: var(--text-secondary);">
					Username
				</label>
				<input
					id="username"
			...
			<div>
				...
				<p class="mt-1 text-xs" style="color: var(--text-muted);">Min 8 characters</p>
			</div>

			<div>
				<label for="confirmPassword" class="mb-1.5 block text-sm font-medium" style="color: var(--text-secondary);">
					Confirm password
				</label>
				<input
					id="confirmPassword"
		...
		<p class="mt-6 text-center text-sm" style="color: var(--text-muted);">
			Have an account?
			<a href="/login" class="font-medium text-accent-500 hover:text-accent-600 transition-colors">
				Sign in
			</a>
		</p>
	</div>
